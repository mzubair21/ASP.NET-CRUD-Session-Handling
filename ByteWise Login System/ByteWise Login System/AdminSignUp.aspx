<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminSignUp.aspx.cs" Inherits="ByteWise_Login_System.AdminSignUp" %>
...
<body>
    <form class="form-control" id="form1" runat="server">
        <div class="text-center">
            ...
            <h2 class="pt-5 mt-5 h1 ">Admin Sign Up</h2>
            <br />
            <br />
            <br />
            <br />
            ...
            <br />
            <asp:Label CssClass="h3" ID="Label9" runat="server" Text="Admin Type"></asp:Label>
            <asp:TextBox CssClass="input-group-lg ml-5" ID="txtadmintype" runat="server" style="margin-bottom: 0px"></asp:TextBox>
