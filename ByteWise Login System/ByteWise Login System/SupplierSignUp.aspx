<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierSignUp.aspx.cs" Inherits="ByteWise_Login_System.SupplierSignUp" %>
...
<body>
    <form class="form-control" id="form1" runat="server">
        <div class="text-center">
            ...
            <h2 class="pt-5 mt-5 h1 ">Supplier Sign Up</h2>
            <br />
            <br />
            <br />
            <br />
            ...
            <br />
            <asp:Label CssClass="h3" ID="Label9" runat="server" Text="Company Name"></asp:Label>
            <asp:TextBox CssClass="input-group-lg ml-5" ID="txtcompanyname" runat="server" style="margin-bottom: 0px"></asp:TextBox>
